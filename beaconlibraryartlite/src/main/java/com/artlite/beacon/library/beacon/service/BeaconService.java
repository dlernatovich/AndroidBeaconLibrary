...
import com.artlite.beacon.BuildConfig;
...
import com.artlite.beacon.library.beacon.distance.DistanceCalculator;
import com.artlite.beacon.library.beacon.distance.ModelSpecificDistanceCalculator;

import com.artlite.beacon.library.beacon.logging.LogManager;
import com.artlite.beacon.library.beacon.service.scanner.CycledLeScanCallback;
import com.artlite.beacon.library.beacon.startup.StartupBroadcastReceiver;
import com.artlite.beacon.library.beacon.utils.ProcessUtils;
import com.artlite.beacon.library.bluetooth.BluetoothCrashResolver;
                ...
                if (startRMData != null) {
                    switch (msg.what) {
                        case MSG_START_RANGING:
                            ...
                            service.startRangingBeaconsInRegion(startRMData.getRegionData(), new com.artlite.beacon.library.beacon.service.Callback(startRMData.getCallbackPackageName()));
                        ...
                        case MSG_START_MONITORING:
                            ...
                            service.startMonitoringBeaconsInRegion(startRMData.getRegionData(), new com.artlite.beacon.library.beacon.service.Callback(startRMData.getCallbackPackageName()));
                            service.setScanPeriods(startRMData.getScanPeriod(), startRMData.getBetweenScanPeriod(), startRMData.getBackgroundFlag());
                            break;
