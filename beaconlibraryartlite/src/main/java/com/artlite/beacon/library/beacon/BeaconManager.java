 ...
 * under the License.
 */
package com.artlite.beacon.library.beacon;
...
import com.artlite.beacon.library.beacon.logging.Logger;
import com.artlite.beacon.library.beacon.logging.Loggers;
import com.artlite.beacon.library.beacon.service.BeaconService;
import com.artlite.beacon.library.beacon.service.Callback;
import com.artlite.beacon.library.beacon.service.MonitoringStatus;
import com.artlite.beacon.library.beacon.service.RangeState;
import com.artlite.beacon.library.beacon.service.RangedBeacon;
import com.artlite.beacon.library.beacon.service.RegionMonitoringState;
import com.artlite.beacon.library.beacon.service.RunningAverageRssiFilter;
import com.artlite.beacon.library.beacon.service.ScanJobScheduler;
import com.artlite.beacon.library.beacon.service.SettingsData;
import com.artlite.beacon.library.beacon.service.StartRMData;
import com.artlite.beacon.library.beacon.service.scanner.NonBeaconLeScanCallback;
import com.artlite.beacon.library.beacon.simulator.BeaconSimulator;
import com.artlite.beacon.library.beacon.utils.ProcessUtils;
...
public class BeaconManager {
     ...
     * {@link LogManager#setLogger(Logger)}
     * instead.
     */
    @Deprecated
    ...
    protected BeaconManager(@NonNull Context context) {
        ...
        mScheduledScanJobsEnabled = Build.VERSION.SDK_INT >= Build.VERSION_CODES.O;
    }
   ...
   @NonNull
     ...
     * {@link LogManager#d(String, String, Object...)} instead.
     */
    @Deprecated
     ...
     * @param t
     * @deprecated This will be removed in a later release. Use
     * {@link LogManager#d(Throwable, String, String, Object...)}
     * instead.
     */
    @Deprecated
